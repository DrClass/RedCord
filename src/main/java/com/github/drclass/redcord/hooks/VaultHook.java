	...
	public static String getPrimaryGroup(Player player) {
        try {
            ...
            if (permissionProvider == null) {
                RedCord.logger.fine("Tried looking up group for player " + player.getName() + " but failed to get the registered service provider for Vault");
                return "";
            }
            ...
            if (!primaryGroup.equals("default")) {
            	...
            	RedCord.logger.fine("Tried looking up group for player " + player.getName() + " but the given group was \"default\"");
                return "";
            }
        } catch (Exception e) {
